package com.shashank.gamify.ui.viewmodels
...
import com.shashank.gamify.data.repositories.ChatRepository
import com.shashank.gamify.utils.ChatRole
import com.shashank.gamify.utils.Event
import com.shashank.gamify.utils.State
import com.shashank.gamify.utils.tryCatch
...
class ChatViewModel @Inject constructor(private val repository: ChatRepository) :
    ...
    init {
        textCopied = "Hi, How may I assist you on your game today?"
        chatMessageList.add(
